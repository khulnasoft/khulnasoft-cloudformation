...
conf="$(awk '{sub("url: https://localhost", "url: https://{{khulnasoft_master_ip}}")}1' /usr/share/kibana/data/khulnasoft/config/khulnasoft.yml)"
echo "${conf}" > /usr/share/kibana/data/khulnasoft/config/khulnasoft.yml  
