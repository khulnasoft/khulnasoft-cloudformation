...
get_plugin_url(){
  ...
  then
  plugin_url="https://packages.khulnasoft.com/4.x/ui/kibana/khulnasoft_kibana-${khulnasoft_major}.${khulnasoft_minor}.${khulnasoft_patch}_${elastic_major_version}.${elastic_minor_version}.${elastic_patch_version}-1.zip"
...
sed -ie '/- default:/,+4d' /usr/share/kibana/data/khulnasoft/config/khulnasoft.yml
cat > /usr/share/kibana/data/khulnasoft/config/khulnasoft.yml << EOF
hosts:
  - default:
...
{
  "changes": {
    "defaultIndex": "khulnasoft-alerts-4.x-*"
  }
}
EOF
